...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a href="/login/logout" data-toggle="tooltip" data-placement="bottom" title="Log Out"><i class="fas fa-sign-out-alt"></i></a>
            </li>
        </ul>
    </div>
</nav>
...
<footer class="container-fluid text-center">
    %{--https://pritomkumar.blogspot.com/2013/07/how-do-i-call-grails-service-from-gsp.html--}%
    <%@ page import="com.kamal.LoginService" %>
    <% def myService = grailsApplication.classLoader.loadClass('com.kamal.LoginService').newInstance() %>
    <p>Courtesy by ${myService.getUserName()}</p>

%{--OR--}%
%{--<p>Courtesy by <CustomTagLib:memberActionMenu/></p>--}%

    <g:if test="${myService.isAdministratorUser()}">
        <p>This is admin user</p>
    </g:if>
    <g:else>
        <p>This is regular user</p>
    </g:else>
